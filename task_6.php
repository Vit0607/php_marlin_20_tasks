...
$experts = [
    ...
    [
        ...
        'tel' => '+13174562564',
        'phone' => '+1 317-456-2564',
        'email' => 'jimmy.fellan@smartadminwebapp.com',
        'address' => '55 Smyth Rd, Detroit, MI, 48341, USA',
        'facebook' => 'facebook.com',
        'twitter' => 'twitter.com',
        'linkedin' => 'linkedin.com',
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="row js-list-filter" id="js-contacts">
        ...
        <?php foreach ($experts as $expert): ?>
            <div class="col-xl-4">
                <div id="c_8" class="card border shadow-0 mb-g shadow-sm-hover"
                     data-filter-tags="<?= $expert['name'] ?>">
                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                        <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?= $expert['status'] ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?= $expert['img'] ?>'); background-size: cover;"></span>
                                </span>
                            <div class="info-card-text flex-1">
                                ...
                                <span class="text-truncate text-truncate-xl"><?= $expert['proffession'] ?></span>
                            </div>
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            <a href="tel:<?= $expert['tel'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                <i class="fas fa-mobile-alt text-muted mr-2"></i> <?= $expert['phone'] ?></a>
                            <a href="mailto:<?= $expert['email'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?= $expert['email'] ?></a>
                            <address class="fs-sm fw-400 mt-4 text-muted">
                                <i class="fas fa-map-pin mr-2"></i> <?= $expert['address'] ?></address>
                            <div class="d-flex flex-row">
                                <a href="<?= $expert['facebook'] ?>" class="mr-2 fs-xxl" style="color:#3b5998">
                                    <i class="fab fa-facebook-square"></i>
                                </a>
                                <a href="<?= $expert['twitter'] ?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                    <i class="fab fa-twitter-square"></i>
                                </a>
                                <a href="<?= $expert['linkedin'] ?>" class="mr-2 fs-xxl" style="color:#0077B5">
